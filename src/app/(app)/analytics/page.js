...
export default async function AnalyticsPage() {
    ...
    return(
        <div>
            <SectionBox>
            <h2 className="text-xl mb-6 text-center text-blue-800 font-bold">PAGE VIEWS</h2>
            ...
            <SectionBox>
                <h2 className="text-xl mb-6 text-center text-blue-800 font-bold">CLICKS (FOR CUSTOM LINKS)</h2>
